...
})({"2fgOX":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "31d71b61b9f0a6b15f23bd77912b0537";
// @flow
...
async function fetchPokemon(url) {
  try {
    ...
    const fetchAllArr = [];
    // fix
    data.results.forEach(function addResult(e) {
      fetchAllArr.push(fetch(e.url).then(function resolve(res) {
        return res.json();
      }));
    });
